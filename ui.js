function updateHud() {
  ...
  setElementHtml(foodText, [
    ...
    makeHudMetric("Render Chunks", renderCacheStats.lastVisibleChunks + "v/" + renderCacheStats.chunks + "c/" + renderCacheStats.lastPendingChunks + "p/" + renderCacheStats.lastGeneratedThisPass + "g"),
...
function updateInspectPanel() {
  ...
  var detailChips = [
    ...
    makeInspectChip("Render Chunks", renderCacheStats.lastVisibleChunks + " visible / " + renderCacheStats.chunks + " cached / " + renderCacheStats.lastPendingChunks + " pending / " + renderCacheStats.lastGeneratedThisPass + " generated"),
