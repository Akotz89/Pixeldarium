PS.assets.registerJSON("data/biomes.json", {
  ...
  "biomes": [
    ...
    { "id": "tundra", "name": "Tundra", "primaryTiles": ["snow", "ice"], "edgeTiles": ["lichen_tundra", "grass_dead", "rock"], "vegetationDensity": 0.18, "treeTypes": ["dwarf_pine", "lichen"], "temperature": { "min": -32, "max": 6 }, "moisture": { "min": 0.2, "max": 0.65 } },
    ...
    { "id": "coastal", "name": "Coastal", "primaryTiles": ["sand", "water_shallow", "river_shallow"], "edgeTiles": ["tidal_mud", "dirt", "wetland"], "vegetationDensity": 0.46, "treeTypes": ["palm", "coastal_grass"], "temperature": { "min": 8, "max": 32 }, "moisture": { "min": 0.55, "max": 1.0 } },
    { "id": "volcanic", "name": "Volcanic", "primaryTiles": ["volcanic", "lava_flow", "rock"], "edgeTiles": ["rock_cliff", "grass_dead"], "vegetationDensity": 0.05, "treeTypes": ["ash_scrub"], "temperature": { "min": 8, "max": 48 }, "moisture": { "min": 0.0, "max": 0.35 } },
    { "id": "wetland", "name": "Wetland", "primaryTiles": ["marsh", "reed_mat", "water_shallow"], "edgeTiles": ["mud", "wetland"], "vegetationDensity": 0.86, "treeTypes": ["willow", "reed", "cypress"], "temperature": { "min": 6, "max": 30 }, "moisture": { "min": 0.75, "max": 1.0 } },
